...
[![Version](https://img.shields.io/badge/Version-0.3.4-8A2BE2)](src/memoria/__version__.py)
...
- 版本号唯一事实源：[src/memoria/\_\_version\_\_.py](src/memoria/__version__.py)（当前 **0.3.2**）
