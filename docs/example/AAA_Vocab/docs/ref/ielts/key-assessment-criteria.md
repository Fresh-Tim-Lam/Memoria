# IELTS Writing Key Assessment Criteria（官方原文）

> **来源**：`https://ielts.org/cdn/Guides/ielts-writing-key-assessment-criteria.pdf`（官方 4 页）
> **获取方式**：WebFetch 读取并逐字转写（该文件官方直链无法直接下载，见同目录 `README.md` §2）
> **用途**：`docs/ielts_band_descriptors.md` §2 的出处
