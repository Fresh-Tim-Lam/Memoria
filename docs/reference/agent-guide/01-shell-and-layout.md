...
- ⚠️ **本轮（2026-09-19：对话面板新增「输入框上方的状态 bar」首版）已断言 / 未取证**。已断言（**harness `docs/example/rich-content-test/_harness.py`，端口 8647**，`MEMORIA_HARNESS_KB` 指向临时库、`MEMORIA_CONFIG_DIR` 隔离；浏览器实测）：
