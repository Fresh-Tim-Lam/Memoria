...
> **关联文档**：[AAA 讨论元规范](./AAA_讨论元规范.md)（规范书写元规则）；[docs-management.md](./docs-management.md)（docs 组织规则）。
...
| 目录 | 职责 |
|------|------|
| `docs/standards/` | 规范（版本、命名、构建发布、代码风格、目录组织）——人机都要遵守 |
| `docs/context/` | AI 注入文档（架构、术语、硬约束、操作指引）——交接与 skill 注入用 |
