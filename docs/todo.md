...
| AG06 | **UI 视觉语言对照与改进**（Memoria 借 dsh 的观感）：四主轴（令牌化/视觉密度/形状与层次/反馈与动效）+ 12 维度对照 + A/B/C 三档改进（A 5 项零风险、B 5 项试点、C 3 项大改） | ⏳ K1 待拍板（设计稿 [design/ui-visual-language.md](design/ui-visual-language.md)；**U1–U6 待选**） |
