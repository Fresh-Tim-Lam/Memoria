...
a = Analysis(
    ...
    hiddenimports=[
        "memoria.app.runtime",
        "memoria.app.shell.pyqt6",
        "memoria.app.shell.pyqt6_host",
        "memoria.app.shell.api_rpc",
        "memoria.app.shell.pyqt6_hidden_chrome",
    ...
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[str(PKG / "pyi_rth_memoria_qtwebengine.py")],
