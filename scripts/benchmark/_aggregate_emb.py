"""Aggregate embedding evaluation results from results_embedding.jsonl."""
import sys
import json
...
src = ROOT / "benchmarks/beir_scifact/results_embedding.jsonl"
if not src.is_file():
    print("No results_embedding.jsonl found!")
    sys.exit(1)
...
out_path = ROOT / "benchmarks/beir_scifact/results_embedding_summary.json"
...
for k, v in summary.items():
    if k in ("kb_path", "modes", "model", "query_count"):
        continue
